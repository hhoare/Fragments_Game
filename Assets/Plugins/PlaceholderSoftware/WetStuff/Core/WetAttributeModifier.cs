...
//            cmd.DrawMesh(fsq, Matrix4x4.identity, _normalsMaterial, 0, 0);
            ...
            if (RenderSettings.Instance.EnableNormalSmoothing)
            {
                ...
                cmd.DrawMesh(fsq, Matrix4x4.identity, _normalSmoothingMaterial, 0, RenderSettings.Instance.EnableStencil ? 2 : 0);
                cmd.SetRenderTarget(BuiltinRenderTextureType.GBuffer2, BuiltinRenderTextureType.CameraTarget);
                cmd.SetGlobalTexture(sourceId, tmpId);
                cmd.DrawMesh(fsq, Matrix4x4.identity, _normalSmoothingMaterial, 0, RenderSettings.Instance.EnableStencil ? 3 : 1);
            ...
            cmd.DrawMesh(fsq, Matrix4x4.identity, _gbufferMaterial, 0, RenderSettings.Instance.EnableStencil ? 1 : 0);
